...
<ParamField path="id" type="string" required={true}>
    ...
    For example, GET ```https://superadmin.voiceaura.ai/v1/voices/david``` or ```GET https://superadmin.voiceaura.ai/v1/voices/ff2c405b-3dba-41e0-9261-bc8ee3f91f46.```
</ParamField>
...
<ResponseField name="voice" type="object">
    ...
    - ```tags``` - A list of tags associated with the voice for the language, voice details, and will have ```"voiceaura Curated"``` for preferred voices.
