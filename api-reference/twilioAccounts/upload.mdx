...
description: Add inbound numbers to malakai from your own Twilio account. See [Enterprise Twilio Integration](http://docs.voiceaura.ai/enterprise-features/custom-twilio) for more information.
---
