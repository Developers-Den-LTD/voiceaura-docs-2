...
api: 'GET /v1/inbound/{phone_number}'
...
<ResponseField name="voice" type="integer">
    ...
    For more information, see [List Voices](http://docs.voiceaura.ai/api-v1/get/voices).
</ResponseField>
...
```json Response
{
    ...
    "prompt": "You're chloe, the helpful AI assistant. The person calling you has inquired...",
