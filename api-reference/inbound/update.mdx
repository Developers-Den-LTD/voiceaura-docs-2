...
<ParamField header="encrypted_key" type="string">
    The ```encrypted_key``` for the Twilio account that owns the phone number you want to modify. Not required if you are using a malakai phone number.
</ParamField>
...
<ParamField body="model" type="string" default="enhanced">
    ...
    <Accordion title="Model differences">
        There are three different ways to use malakai:
