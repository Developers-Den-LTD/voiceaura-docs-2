...
// API request
await axios.post("https://superadmin.voiceaura.ai/v1/calls", data, { headers });
...
# API request
response = requests.post('https://superadmin.voiceaura.ai/v1/calls', json=data, headers=headers)

```

</RequestExample>

<img src="/images/maxDuration.png" />

## Introduction

Controlling the length of your AI-powered phone calls is crucial for efficiency and cost-effectiveness. In this guide, we’ll walk you through how to set a ```max_duration ```for your calls using Voiceaura AI.
...
Ensure you have your API key ready for authentication. If you haven’t obtained one, sign up on the [developer portal](https://api.platform.com/).
...
Setting a ```max_duration``` for your calls ensures they are concise and to the point, saving time and resources. You’re now ready to efficiently manage the length of your AI-powered calls with Voiceaura AI.
