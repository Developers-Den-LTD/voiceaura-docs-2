...
<Accordion title="Expand to see an example in action">
    ...
    ```Endpoint: POST https://api.malakai.ai/v1/inbound/<<INBOUND NUMBER>>```

    ```javascript
    {
    "prompt": "You're a service agent working on behalf of malakai AI...",
    "dynamic_data": [
        {
            // First, retrieve the previous call's data
            "url": "https://api.malakai.ai/v1/calls",
            "method": "GET",
            "headers": {
        ...
        },
        {
            ...
            "url": "https://api.malakai.ai/v1/calls/{{previous_call_id}}",
            "method": "GET",
            "headers": {
                "authorization": <<YOUR API KEY>>
            },
