...
Gain greater control over your AI agent and the conversational flow. [Create a Pathway Now!](https://api.platform.com/login)
...
Conversational pathways are our new way of prompting voiceaura that has led to major breakthroughs in realism.

<CardGroup cols={2}>
  <Card
    title="Greater dialogue control"
    icon="pen-to-square"
  >
    Give your agent instructions on how it should respond at specific points of
    the conversation. Choose between prompting or fixed sentences.
  </Card>
  <Card
    title="Webhooks"
    icon="image"
  >
    Execute webhooks at any point during the conversation, and send speech
    during/after the webhook.
  </Card>
  <Card
    title="End call"
    icon="image"
  ...
  <Card
    ...
    icon="image"
  >
    Connect your agent to a knowledge base, to answer any questions the user
    has.
  </Card>
</CardGroup>
...
You can select the type of node you want by clicking on the dropdown of `Node Base`
...
`Webhook Information` is all you need in order to execute a webhook, and works the same way as Dynamic Data. Refer to the [Dynamic Data](http://docs.voiceaura.ai/tutorials/dynamic-data) section for more information.
...
Create a pathway now! Click [here](https://api.platform.com/login)  to get started!
