...
To understand how custom tools work, let’s take a peek under the hood of the Voiceaura AI phone agent.
...
<AccordionGroup>
  <Accordion title="How does the phone agent determine what it sends an API requests?">
  ...
  <Accordion title="How does the phone agent decide when to use cusotm tool?">
...
If you have any additional questions, reach out at [info@voiceaura.ai](mailto:info@voiceaura.ai) and one of our engineers will help.
