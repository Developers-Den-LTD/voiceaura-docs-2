...
This is a quick tutorial to help you set up and test your Voiceaura AI webhook. We’ll include instructions both for inbound and outbound phone calls.
...
Then, follow the [send phone call](http://docs.voiceaura.ai/api-reference/basic/sendCall) docs to create and send a phone call. Make sure you include the ```webhook``` as a parameter in your request. After, confirm that the webhook data populated on your webhook site page.
