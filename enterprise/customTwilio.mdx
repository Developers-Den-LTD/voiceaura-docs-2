...
Once you update an inbound number through the [Dev Portal](https://api.platform.com/) or [API](http://docs.voiceaura.ai/api-reference/inbound/update), that number will be automatically configured to run on malakai’s infrastructure. No additional steps are required!
