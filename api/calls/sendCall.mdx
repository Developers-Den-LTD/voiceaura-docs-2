...
<ParamField body="start_node_id" type="string">
    This is the node ID for the node you want the pathway to start from. You can access the ID of your nodes [here](http://docs.voiceaura.ai/api-v1/get/convo_pathway)
...
<ParamField body="voice" type="string" default="mason">
   The voice of the AI agent to use. Accepts any form of voice ID, including custom voice clones and voice presets.
    ...
    Use the [GET /v1/voices](http://superadmin.voiceaura.ai/voices) endpoint to see a full list of your available voices.
